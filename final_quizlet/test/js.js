var out = {};
fetch('http://localhost/json/index.php').then(response => response.json())
    .then(function (test) {
            console.log(test);
            out = test;
...
// test = {
//     question_arr : ["1. Расшифруйте аббревиатуру HTML", "2. Существует ли у тега inpyt закрывающий тег в синтаксисе HTML?", "3. Если Вам потребуется " +
...
//     a1_arr : ["HeadText Modulation Language", "Да", "Тег: p", "Атрибут : alt", "Строчным", "ul", "одиночных", "field"],
//     a2_arr : ["HyperText Markup Language", "Нет", "Тег: link", "Атрибут : href", "Блочным", "ol", "парных", "input"],
//     a3_arr : ["HeadingText Mode Language", "Такого тега в стандартах HTML не существует", "Тег: a", "Атрибут : name", "Является как строчным, так и блочным элементом", "al", "тройных", "a"],
//     answer_arr : ["HyperText Markup Language", "Такого тега в стандартах HTML не существует", "Тег: a", "Атрибут : href", "Блочным", "ol", "тройных", "input"],
//
